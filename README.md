...
To start the counter for a specific type of data, in this case profile, which keeps track of the number of pieces of information processed by this interpreter, do this.
